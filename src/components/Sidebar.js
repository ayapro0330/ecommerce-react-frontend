...
const Sidebar = () => {
  ...
  const { cartItems , clearCart , totalAmount , totalItems} = useContext(CartContext);
    ...
    >
      ...
      <div className=" flex flex-col gap-y-3 py-4 mt-4">
        <div className=" flex w-full justify-between items-center">
          ...
          flex justify-center items-center text-xl lg:px-5" onClick={() => clearCart()}>
            <FiTrash2/></div>
        </div>
        <Link to={'/'} className="bg-grey-200 flex p-4 justify-center
